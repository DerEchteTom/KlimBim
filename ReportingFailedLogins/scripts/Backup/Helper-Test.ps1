...
# Alle Felder für SQL-Abfrage verwenden
...
switch ($ShowStep) {
    'HTML' {
        ...
        # ============================================
        # HTML-Generierung ohne Sprachumschaltung
        # ============================================
        $htmlOut = @"
<!DOCTYPE html>
<html lang='de'>
...
<body>
  ...
  <button id='toggleBtn' onclick='showAll()'>Alle Spalten anzeigen</button>
...
"@
        ...
        # ============================================
        # HTML-Datei speichern mit UTF-8 inkl. BOM
        # ============================================
        [System.IO.File]::WriteAllText($targetPath, $htmlOut, [System.Text.Encoding]::UTF8)
        Write-Host ""
